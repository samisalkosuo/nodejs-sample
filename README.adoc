...
One way to deploy this app to OpenShift is described here. We are going to use OCP feature to build container images from source. 

But why not S2I? IMHO, I have more control and I know exactly what is running when I use my own container image instead of letting OCP to select runtime based on the source. 
